...
- Opening [GitHub issues](https://github.com/y-sunflower/realcolor/issues) to list the bugs you've found
...
```bash
git clone https://github.com/github_user_name/realcolor.git
cd realcolor
git remote add upstream https://github.com/y-sunflower/realcolor.git
```
...
Congrats! Once your PR is merged, it will be part of `realcolor`.
